...
p;10;CPBundle.jt;3121;@STATIC;1.0;i;10;CPObject.ji;14;CPDictionary.ji;14;CPURLRequest.jt;3049;
objj_executeFile("CPObject.j",true);
objj_executeFile("CPDictionary.j",true);
...
p;8;CPData.jt;2740;@STATIC;1.0;i;10;CPObject.ji;10;CPString.jt;2691;
objj_executeFile("CPObject.j",true);
objj_executeFile("CPString.j",true);
...
}),new objj_method(sel_getUid("initWithSerializedPlistObject:"),function(_6,_7,_8){
with(_6){
_6=objj_msgSendSuper({receiver:_6,super_class:objj_getClass("CPData").super_class},"init");
if(_6){
objj_msgSend(_6,"setSerializedPlistObject:",_8);
}
return _6;
}
}),new objj_method(sel_getUid("initWithSerializedPlistObject:format:"),function(_9,_a,_b,_c){
with(_9){
_9=objj_msgSendSuper({receiver:_9,super_class:objj_getClass("CPData").super_class},"init");
if(_9){
objj_msgSend(_9,"setSerializedPlistObject:format:",_b,_c);
}
return _9;
}
}),new objj_method(sel_getUid("length"),function(_d,_e){
with(_d){
return objj_msgSend(objj_msgSend(_d,"encodedString"),"length");
}
}),new objj_method(sel_getUid("description"),function(_f,_10){
with(_f){
return _f.toString();
}
}),new objj_method(sel_getUid("encodedString"),function(_11,_12){
with(_11){
return _11.encodedString();
}
}),new objj_method(sel_getUid("setEncodedString:"),function(_13,_14,_15){
with(_13){
_13.setEncodedString(_15);
}
}),new objj_method(sel_getUid("serializedPlistObject"),function(_16,_17){
with(_16){
return _16.serializedPropertyList();
}
}),new objj_method(sel_getUid("setSerializedPlistObject:"),function(_18,_19,_1a){
with(_18){
_18.setSerializedPropertyList(_1a);
}
}),new objj_method(sel_getUid("setSerializedPlistObject:format:"),function(_1b,_1c,_1d,_1e){
with(_1b){
_1b.setSerializedPropertyList(_1d,_1e);
}
})]);
class_addMethods(_2,[new objj_method(sel_getUid("alloc"),function(_1f,_20){
with(_1f){
...
}),new objj_method(sel_getUid("dataWithEncodedString:"),function(_23,_24,_25){
with(_23){
return objj_msgSend(objj_msgSend(_23,"alloc"),"initWithEncodedString:",_25);
}
}),new objj_method(sel_getUid("dataWithSerializedPlistObject:"),function(_26,_27,_28){
with(_26){
return objj_msgSend(objj_msgSend(_26,"alloc"),"initWithSerializedPlistObject:",_28);
}
}),new objj_method(sel_getUid("dataWithSerializedPlistObject:format:"),function(_29,_2a,_2b,_2c){
with(_29){
return objj_msgSend(objj_msgSend(_29,"alloc"),"initWithSerializedPlistObject:format:",_2b,_2c);
}
})]);
...
p;10;CPNumber.jt;5991;@STATIC;1.0;i;10;CPObject.ji;15;CPObjJRuntime.jt;5937;
objj_executeFile("CPObject.j",true);
...
p;10;CPObject.jt;6663;@STATIC;1.0;t;6644;
...
p;9;CPProxy.jt;3589;@STATIC;1.0;i;13;CPException.ji;14;CPInvocation.ji;10;CPString.jt;3518;
objj_executeFile("CPException.j",true);
...
p;10;CPString.jt;10236;@STATIC;1.0;i;10;CPObject.ji;13;CPException.ji;18;CPSortDescriptor.ji;9;CPValue.jt;10147;
objj_executeFile("CPObject.j",true);
objj_executeFile("CPException.j",true);
objj_executeFile("CPSortDescriptor.j",true);
objj_executeFile("CPValue.j",true);
...
with(_69){
var _6b=_1.valueForKey(_69);
if(!_6b){
_6b=_objj_generateObjectHash();
_1.setValueForKey(_69,_6b);
}
return _6b;
}
...
p;17;CPURLConnection.jt;5416;@STATIC;1.0;i;10;CPObject.ji;11;CPRunLoop.ji;14;CPURLRequest.ji;15;CPURLResponse.jt;5327;
objj_executeFile("CPObject.j",true);
objj_executeFile("CPRunLoop.j",true);
objj_executeFile("CPURLRequest.j",true);
